<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/my\index.html";i:1512060407;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="__ROOT__/static/home/other/image/5.png" width="60" height="60" />
            </div>
            <div class="col-xs-9">
                <?=$nikename?><br/>
                北大花园小区<br/>
        ...
        <div class="row text-center myLabel">
            ...
            <div class="col-xs-4 label-success"><a href="<?php echo url('repair/getRepair'); ?>"><span class="iconfont">&#xe609;</span>我的报修</a></div>
            <div class="col-xs-4 label-primary"><a href="<?php echo url('my/getActives'); ?>"><span class="iconfont">&#xe606;</span>报名的活动</a></div>
        </div>
        <div class="blank"></div>
        <div>
...
<script src="_ROOT__/static/home/other/jquery-1.11.2.min.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="_ROOT__/static/home/other/js/bootstrap.min.js"></script>
</body>
</html>