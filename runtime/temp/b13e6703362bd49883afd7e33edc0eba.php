<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/server\tips.html";i:1512024907;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
            ...
            $.getJSON(path,function (data) {
                ...
                if (json.success == 1){
                    ...
                    $(lists).each(function(index,item){
                        ...
                        html += '</div></a>';
                        if(item.category_id == 49 || item.category_id == 50){
