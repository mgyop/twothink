...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'Bg%r<k*,GyO32Pi(XqHVo#bC?Qa;8Y_R!I>T$.|7', //默认数据加密KEY
	'data_cache_key'=> 'Bg%r<k*,GyO32Pi(XqHVo#bC?Qa;8Y_R!I>T$.|7',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'Bg%r<k*,GyO32Pi(XqHVo#bC?Qa;8Y_R!I>T$.|7', //加密KEY
